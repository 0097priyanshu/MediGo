 ...
 * Allows user authentication via email & password.
 */
const Login = () => {
  ...
  // Retrieve intended redirection path after successful authentication
      ...
      <div className="flex min-h-[calc(100vh-140px)] items-center justify-center bg-teal-50/20 px-4 py-12">
        <Card className="w-full max-w-md border-teal-100/80 shadow-xl bg-white/80 backdrop-blur-md">
          <CardHeader className="space-y-2 text-center pb-4">
            <CardTitle className="text-3xl font-extrabold text-teal-850 tracking-tight">Welcome Back</CardTitle>
            <CardDescription className="text-sm text-slate-500 max-w-[280px] mx-auto">
              Sign in to secure access to your medicines and order trackers.
            </CardDescription>
          </CardHeader>
