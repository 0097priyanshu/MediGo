...
import { MapPin, Star, Clock, Sparkles, Loader2, AlertCircle, ShoppingBag, Eye, HelpCircle } from "lucide-react";
...
// Declaring simple X icon internally to avoid import errors
const X = ({ className }) => (
